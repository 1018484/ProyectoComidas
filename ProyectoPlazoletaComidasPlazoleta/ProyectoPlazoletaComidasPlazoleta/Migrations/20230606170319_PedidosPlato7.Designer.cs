...
namespace ProyectoPlazoletaComidasPlazoleta.Migrations
{
    ...
    [Migration("20230606170319_PedidosPlato7")]
    partial class PedidosPlato7
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dominio.Modelos.PedidosPlatos", b =>
                {
                    b.Property<int>("PedidosPlatos_Id")
                        .HasColumnType("int");

                    b.Property<int>("Cantidad")
                        .HasColumnType("int");

                    b.Property<Guid>("PedidosPedido_Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("PlatosId")
                        .HasColumnType("int");

                    b.HasKey("PedidosPlatos_Id");

                    b.HasIndex("PedidosPedido_Id");
            ...
            modelBuilder.Entity("Dominio.Modelos.PedidosPlatos", b =>
                {
                    b.HasOne("Dominio.Modelos.Pedidos", null)
                        .WithMany("PedidosPlatos")
                        .HasForeignKey("PedidosPedido_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
